    ...
    return (
      <div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', width: '90%', margin: '0 auto' }}>
          {results.map(movie => {
            return (
              <div key={movie.id} style={{ width: '300px', borderRadius: '10px', margin: '1%', boxShadow: '0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23)' }}>
                <div style={{ position: 'relative', height: '450px', overflow: 'hidden', borderRadius: '10px 10px 0 0' }}>
