...
const ListItemText = styled.div`
  ...
  border: ${(props) =>
    props.selected ? "1px solid rgba(0,0,0,0.2)" : "1px solid transparent"};
  border-radius: 15px;
  padding: 5px 15px;
  margin-bottom: 5px;
  white-space: nowrap;
  ...
  :hover {
    border: ${(props) =>
      props.selected ? "1px solid rgba(0,0,0,0.2)" : "1px solid #eee"};
  }
`;
